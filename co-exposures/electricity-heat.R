...
elec_temp <- left_join(elec_aggregate, temperature)

### get the number of times this happens at hot temperatures:

elec_temp_agg <- elec_temp %>%
...
write.csv(elec_temp_agg, "heat-electric.csv")
