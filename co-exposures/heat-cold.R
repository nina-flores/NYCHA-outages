...
heat_temp <- left_join(heat_aggregate, temperature)

### get the number of times this happens at hot temperatures:

heat_temp_agg <- heat_temp %>%
...
write.csv(heat_temp_agg, "heat-cold.csv")
